...
public class HttpRestUtils {
	...
	public static <U> ResponseEntity<U> getData(RestTemplate restTemplate, String url, Map<String, String> headerMap, Map<String, Object> uriVariables, Class<U> responseType)
	...
	public static <T> void putData(RestTemplate restTemplate, String url, Map<String, String> headerMap, T map, Map<String, Object> uriVariables) throws RestClientException {
		HttpHeaders httpHeaders = new HttpHeaders();
	...
	public static <T> void putData(String url, Map<String, String> headerMap, T data, Map<String, Object> uriVariables) throws RestClientException {
